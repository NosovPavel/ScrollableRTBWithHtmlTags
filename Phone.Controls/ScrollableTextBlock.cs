...
namespace Phone.Controls
{
    public class ScrollableTextBlock : Control
    {
        ...
        private RichTextBox measureBlock;
        ...
        private void ParseTextHide(string value)
        {
            ...
            if (value.Length < maxTexCount)
            {
                ...
                RichTextBlockExtensions.SetHtmlContent(textBlock, value);
            ...
            else
            {
                ...
                {
                    RichTextBox textBlock = this.GetTextBlock();
                    //textBlock.Set = value.Substring(start, maxTexCount);
                    RichTextBlockExtensions.SetHtmlContent(textBlock, value.Substring(start, maxTexCount));
                    this.stackPanel.Children.Add(textBlock);
                    start = maxTexCount;
                }
                ...
                if (value.Length % maxTexCount > 0)
                {
                    ...
                    RichTextBlockExtensions.SetHtmlContent(textBlock, value.Substring(maxTexCount * n, value.Length - maxTexCount * n));
                    this.stackPanel.Children.Add(textBlock);
                }
            }
        }
        ...
        private void ParseLine(string line)
        {
            ...
            RichTextBlockExtensions.SetHtmlContent(textBlock, sbLine.ToString());
            this.stackPanel.Children.Add(textBlock);
        ...
        private Size MeasureString(string text)
        {
            ...
            RichTextBlockExtensions.SetHtmlContent(measureBlock, text);
